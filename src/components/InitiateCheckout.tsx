        ...
        <div className="mt-6 border-t pt-4">
          ...
          <div className="flex justify-between items-center mt-2">
            ...
            <span className="text-xl font-bold text-gray-900">
              $ {totalPrice && Math.round(totalPrice + 200)}
            </span>
          </div>

          <button className="w-full mt-6 bg-green-600 text-white font-semibold py-3 rounded-lg hover:bg-green-700 transition-colors duration-300">
            Checkout
          </button>
        </div>
      )}
